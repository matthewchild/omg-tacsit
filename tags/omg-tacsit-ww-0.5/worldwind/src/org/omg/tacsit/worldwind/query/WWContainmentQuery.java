...
import org.omg.tacsit.query.ContainmentQuery;
import org.omg.tacsit.worldwind.entity.GeometryEntity;
import org.omg.tacsit.worldwind.geometry.WWSurfaceGeometry;

/**
 * A query that determines whether an entity is completely contained by the surface geometry.
 * <p>
 * This provides an implementation of the Tacsit standard's ContainmentQuery for Worldwind.
 * @author Matthew Child
 */
public class WWContainmentQuery extends WWGeometryQuery implements ContainmentQuery
{
  /**
   * Creates a new instance.
   */
  public WWContainmentQuery()
  {
  }

  /**
   * Creates a new instance.
   * @param geometry The geometry that will be used to check if entities are contained within.
   */
  public WWContainmentQuery(WWSurfaceGeometry geometry)
  {
    super(geometry);
  }
  ...
  public boolean satifies(Entity entity)
  {
    ...
    if(geometry != null)
    {
      ...
      else if(entity instanceof GeometryEntity)
      {
        ...
        satisfies = geometry.contains(geometryEntity.getGeometry());
      }
    }
